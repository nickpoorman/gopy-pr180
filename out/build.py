...
mod.add_function('Array_2_int_CTor', retval('int64_t'), [])
mod.add_function('Array_2_int_len', retval('int'), [param('int64_t', 'handle')])
mod.add_function('Array_2_int_elem', retval('int64_t'), [param('int64_t', 'handle'), param('int', 'idx')])
mod.add_function('Array_2_int_set', None, [param('int64_t', 'handle'), param('int', 'idx'), param('int64_t', 'value')])
mod.add_function('hi_Anon', retval('int64_t'), [])
mod.add_function('hi_Set_Anon', None, [param('int64_t', 'val')])
mod.add_function('hi_Debug', retval('bool'), [])
mod.add_function('hi_Set_Debug', None, [param('bool', 'val')])
mod.add_function('hi_IntArray', retval('int64_t'), [])
mod.add_function('hi_IntSlice', retval('int64_t'), [])
mod.add_function('hi_Set_IntSlice', None, [param('int64_t', 'val')])
mod.add_function('hi_PersIface_GetAge', retval('int64_t'), [param('int64_t', '_handle')])
mod.add_function('hi_PersIface_GetName', retval('char*'), [param('int64_t', '_handle')])
mod.add_function('hi_PersIface_Greet', retval('char*'), [param('int64_t', '_handle')])
mod.add_function('hi_PersIface_SetAge', None, [param('int64_t', '_handle'), param('int64_t', 'age'), param('bool', 'goRun')])
mod.add_function('hi_PersIface_SetName', None, [param('int64_t', '_handle'), param('char*', 'n'), param('bool', 'goRun')])
mod.add_function('hi_Couple_CTor', retval('int64_t'), [])
mod.add_function('hi_Couple_P1_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('hi_Couple_P1_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
mod.add_function('hi_Couple_P2_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('hi_Couple_P2_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
mod.add_function('hi_Couple_String', retval('char*'), [param('int64_t', '_handle')])
mod.add_function('hi_Person_CTor', retval('int64_t'), [])
mod.add_function('hi_Person_Name_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('hi_Person_Name_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
mod.add_function('hi_Person_Age_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('hi_Person_Age_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
mod.add_function('hi_Person_String', retval('char*'), [param('int64_t', '_handle')])
mod.add_function('hi_Person_Greet', retval('char*'), [param('int64_t', '_handle')])
mod.add_function('hi_Person_Work', retval('char*'), [param('int64_t', '_handle'), param('int64_t', 'h')])
mod.add_function('hi_Person_Salary', retval('int64_t'), [param('int64_t', '_handle'), param('int64_t', 'h')])
mod.add_function('hi_Person_GetName', retval('char*'), [param('int64_t', '_handle')])
mod.add_function('hi_Person_GetAge', retval('int64_t'), [param('int64_t', '_handle')])
mod.add_function('hi_Person_SetName', None, [param('int64_t', '_handle'), param('char*', 'n'), param('bool', 'goRun')])
mod.add_function('hi_Person_SetAge', None, [param('int64_t', '_handle'), param('int64_t', 'age'), param('bool', 'goRun')])
mod.add_function('hi_Person_SetFmS2', None, [param('int64_t', '_handle'), param('int64_t', 's2'), param('bool', 'goRun')])
mod.add_function('hi_Person_SetFmS2Ptr', None, [param('int64_t', '_handle'), param('int64_t', 's2'), param('bool', 'goRun')])
mod.add_function('hi_Person_ReturnS2Ptr', retval('int64_t'), [param('int64_t', '_handle')])
mod.add_function('hi_Floats_CTor', retval('int64_t'), [])
mod.add_function('hi_Floats_len', retval('int'), [param('int64_t', 'handle')])
mod.add_function('hi_Floats_elem', retval('float'), [param('int64_t', 'handle'), param('int', 'idx')])
mod.add_function('hi_Floats_set', None, [param('int64_t', 'handle'), param('int', 'idx'), param('float', 'value')])
